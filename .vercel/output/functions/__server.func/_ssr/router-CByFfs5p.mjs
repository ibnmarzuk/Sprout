...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CByFfs5p.js
var router_CByFfs5p_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DwKf_GAe.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "SPROUT is an onchain eco-native brand. Grow online. Plant offline. Follow the growth."
			},
			{
				name: "theme-color",
				content: "#0c140f"
...
var $$splitComponentImporter = () => import("./routes-CdXBwGvM.mjs");
...
//#endregion
export { getRouter, router_CByFfs5p_exports as t };
